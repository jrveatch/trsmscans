...
class sample_points:
    ...
    def pass_info(self, params: Params, identifier: str, decay: str, npoints: int) -> Parse:
        ...
        # initialize parser without tsv
        self.parser = Parse(params.masses(), decay, self.model_name)

        # initialize class objects for filters
        self.nwidth = 0
        self.nbounds = 0
        self.npass = 0

        # initialize the current points run for the scan
        curr_points_run: int = 0

        # run points until valid points meet the criteria of the points requested
        while self.npass < self.npoints:

            print(f'{npoints} requested, running ScannerS...')
            ...
            print(f'Applying filters to points...')
            ...
            print(f'{npass} points passed filters')
            ...
            print(f'Points passed with an efficency of {efficiency}')
